...
|---|---|---|---|---|
| **A1 (production)** | **256/256** | **0** (max 1 erase/row) | **11,616 B ≤ 12288** | **4,919,618 B = −2.105 % vs byte model** |

- Real +1-face update (113,124 ↔ 113,484, +360 B): **grow 925 / revert 635 B** (byte model 933/647).
