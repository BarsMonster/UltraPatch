...
ARM_DEC_FLAGS=${ARM_DEC_FLAGS:-"-mcpu=cortex-m0plus -mthumb -std=c11 -DPATCH_IMAGE_BASE=0u -DPATCH_IMAGE_CAPACITY=67108864u -I src"}
ARM_OBJECT_OPT=${ARM_OBJECT_OPT:--Os}
DECODER_INTEGRATION_TU=${DECODER_INTEGRATION_TU:-test-bench/decoder-integration.c}
BASE_FOOTPRINT_FLASH=${BASE_FOOTPRINT_FLASH:-5557}
