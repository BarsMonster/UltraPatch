...
`images/` and `fixtures/` are local binary corpora used by the A1 C verification checks. They are ignored to keep the repository small; `v3/nvm/hybrid12k` links to them.
